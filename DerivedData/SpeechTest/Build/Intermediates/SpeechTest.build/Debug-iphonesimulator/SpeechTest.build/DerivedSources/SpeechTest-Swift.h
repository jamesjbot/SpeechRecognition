...
SWIFT_CLASS("_TtC10SpeechTest11AppDelegate")
...
@property (nonatomic, readonly, strong) AVAudioEngine * _Nonnull audioEngine;
@property (nonatomic, readonly, strong) SFSpeechRecognizer * _Nullable speechRecognizer;
@property (nonatomic, readonly, strong) SFSpeechAudioBufferRecognitionRequest * _Nonnull recognitionRequest;
@property (nonatomic, strong) SFSpeechRecognitionTask * _Nullable recognitionTask;
